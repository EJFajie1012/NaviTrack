...
// This now correctly executes ONLY for authorized admins
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="border-b border-white/10 bg-white/5">
                                    <th class="text-left p-6">User ID</th>
                                    <th class="text-left p-6">Name</th>
                                    <th class="text-left p-6">Role</th>
                                ...
                                while($row= mysqli_fetch_assoc($result)){
                                    ...
                                    echo "<th class='text-left p-6'>" . $row['user_id'] . "</th>";
                                    echo "<th class='text-left p-6'>" . $row['username'] . "</th>";
                                    echo "<th class='text-left p-6'>" . $row['role_id'] . "</th>";
                                    echo "<th class='text-left p-6'>" . $row['email'] . "</th>";
                                    echo "<th class='text-left p-6'>" . $status . "</th>";
